...
content = [
    ...
    dcc.Interval(id='interval-component-main', interval=60 * 1000, n_intervals=0),
    html.Div(children=html.Div(id='graphs'), className='row'),
    dcc.Interval(id='interval-component', interval=60 * 1000, n_intervals=0),

    html.Footer(html.Div(html.Div(
        html.Div(html.Span('York Python-Advanced Course Pi-Air Project'), className='col-sm-8 col-sm-offset-2 text-center'),
